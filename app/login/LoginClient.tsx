    ...
    <div style={{
      ...
      <div style={cardStyle}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <div style={{ fontFamily: 'var(--font-bebas), sans-serif', fontSize: '28px', letterSpacing: '4px', color: '#C9A84C' }}>{title}</div>
          <div style={{ fontSize: '13px', color: '#6B7280', letterSpacing: '2px', textTransform: 'uppercase', marginTop: '2px' }}>{subtitle}</div>
        </div>
        ...
        {tab === 'password' && (
          <form onSubmit={handlePasswordLogin} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <button type="submit" disabled={pwLoading} style={{ padding: '14px', borderRadius: '8px', border: 'none', background: `linear-gradient(135deg, ${accentColor}, ${accentColor}88)`, color: '#fff', fontSize: '15px', fontWeight: '700', cursor: pwLoading ? 'not-allowed' : 'pointer', opacity: pwLoading ? 0.7 : 1, boxShadow: `0 4px 16px ${accentColor}44` }}>

...
import PalmsClient from './PalmsClient'
...
export default async function PalmsPage() {
  ...
  const [members, palmsThisWeek, allPalms, pins] = await Promise.all([
    db.user.findMany({
    ...
    // Last 26 weeks of PALMS for traffic light scores
    db.palmsEntry.findMany({
      orderBy: { weekDate: 'desc' },
      take: 2000, // reasonable upper bound (50 members × 26 weeks)
    }),

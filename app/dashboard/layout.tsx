...
// Visibility rules:
//   access: 'all'       → any dashboard user (officer + superadmin)
//   access: 'officer'   → officer or superadmin
//   access: 'superadmin'→ superadmin only
//   roles: [...]        → only these specific role slugs (in addition to superadmin always seeing it)
type NavItem = {
  href: string
  ...
  roles?: string[] // extra allowed role slugs beyond superadmin
}
...
// Bottom nav (mobile) — 5 max, all-access items only
...
function SidebarContent({ pathname, onClose }: { pathname: string; onClose?: () => void }) {
  ...
  return (
    <div className="glass-sidebar" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
      ...
      {/* User footer — name + sign out, no avatar (avatar lives in topbar ProfileMenu) */}
      <div style={{ padding: '12px', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div style={{ padding: '6px 12px 8px', overflow: 'hidden' }}>
          ...
          <div style={{ fontSize: '11px', color: '#C9A84C', textTransform: 'capitalize', fontWeight: '400' }}>
    ...
    <div ref={ref} style={{ position: 'relative' }}>
      ...
      >
        ...
        <div style={{ textAlign: 'right' }} className="hidden sm:block">
          ...
          <div style={{ fontSize: '11px', fontWeight: '400', color: '#C9A84C', textTransform: 'capitalize', lineHeight: '1.2' }}>{role}</div>
        </div>
        {/* Avatar circle */}
        <div
          style={{
            ...
            fontWeight: '700', fontSize: '14px', color: '#C9A84C', transition: 'all 0.15s',
          }}
        >
          {initials}
        </div>
        ...
        <div style={{
          ...
          <div style={{ padding: '14px 16px', borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              <div style={{ overflow: 'hidden' }}>
                ...
                <div style={{ fontSize: '12px', color: '#C9A84C', textTransform: 'capitalize', fontWeight: '600' }}>{role}</div>
              </div>
            </div>
          </div>
          ...
          <div style={{ padding: '6px' }}>
            ...
            <Link
              ...
              onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = '#9CA3AF' }}
            >
              <UserCircle size={15} style={{ color: '#6B7280' }} />
              My Contacts
            </Link>
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        {/* Desktop topbar — profile icon top-right */}
        <div
        ...
        >
          ...
          <div className="lg:hidden" style={{ height: '196px' }} />
        </main>
      </div>
